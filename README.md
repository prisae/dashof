...
In oder to make it work, you have to adjust a few things in your `pelicanconfip.py`:
...
3. I blog-name in the static menu must agree with your `BLOGDIR` (the example
   is from my setting):
